...
#define TOOLING_TEST_BOARD  1   // 根据实际设备类型编号填写
...
typedef struct {
    ...
    INT32U dwFrameInterval; // 新增帧间隔参数
    // ...其他参数...
...
typedef struct
{
    unsigned char ucDeviceType;           // 设备类型
    ...
    WIEGAND_CONFIG_PARAM WiegandConfigParam; // 新增韦根配置参数

    unsigned char szRes[1333 - sizeof(WIEGAND_CONFIG_PARAM)]; // 保证总大小不变
