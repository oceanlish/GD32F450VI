...
#define ENET_RXBUF_NUM                   20U                                     /*!< ethernet Rx DMA descriptor number */
#endif

#ifndef ENET_TXBUF_NUM
#define ENET_TXBUF_NUM                   20U                                     /*!< ethernet Tx DMA descriptor number */
#endif
...
#define LAN8720_PHY_ADDRESS              ((uint16_t)0U)       
...
#define PHY_LINK_STATUS                ((uint16_t)0x0004)                     /*!< configured information of duplex: full-duplex */

#define PHY_AN_LPAR                            5
#define PHY_100BASE_TX_STATUS  					      ((uint16_t)0x0080)							/*7  --> 100BASE-TX*/
#define PHY_100BASE_TX_FULL_DUPLEX_STATUS  		((uint16_t)0x0100)							/*8 -->100BASE-TX Full Duplex*/
